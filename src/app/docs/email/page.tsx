  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-10">
      ...
      <p className="text-muted">
        Calendar reminders can be emailed automatically to addresses already in US360 — your account email and her
        email on Profile. WhatsApp, Instagram, Facebook, and Reels are never auto-sent.
      </p>
      ...
      <Card>
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-6">
          ...
          <li>Confirm your account email, add her email on Profile if partner notes should reach her, and turn on Email + Events in Settings.</li>
      ...
      <Card>
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 text-sm leading-6">
          ...
          <li>Prepared notes for her → her Profile email</li>
